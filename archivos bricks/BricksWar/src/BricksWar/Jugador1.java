...
public class Jugador1 implements KeyListener {
	...
	public static final int teclaIzquierda=Teclas.teclas[0][0];
	public static final int teclaDerecha=Teclas.teclas[0][1];
	public static final int teclaDisparo=Teclas.teclas[0][2];
	public static final int teclaSalto=Teclas.teclas[0][3];
	public static final int teclaAgacharse=Teclas.teclas[0][4];
	public static final int teclaArriba=Teclas.teclas[0][5];
	public static final int teclaAbajo=Teclas.teclas[0][6];
	...
	private int contadorQuema=0,sumaY,altoDelSalto=0,accionAnterior=0,poderDeSalto=5,direccion=2,contador2=0;
    ...
    private int marcaPasos=0,altura=0,contador=0,accionActual=0,auxX=personaje.getX(0),auxY=personaje.getY(0),ancho=40,alto=40;
    ...
    public void actualiza() {
    	...
    	if(contador==0){
    		...
    		if(bloqueado()==true || MapaTiles.map[personaje.getY(0)+3][personaje.getX(0)+1]==1 || MapaTiles.jugadores[personaje.getY(0)+3][personaje.getX(0)+1]==1){
    			auxX=personaje.getX(0);
    			...
    			if((derecha==true || derecha2==true) && izquierda==false && izquierda2==false && accionActual!=5){//si no puede mover el pie hacia la derecha.
    				if((MapaTiles.jugadores[personaje.getY(0)+3][personaje.getX(0)+2]==1 || MapaTiles.jugadores[personaje.getY(0)+3][personaje.getX(0)+2]==1) || (MapaTiles.map[personaje.getY(0)+3][personaje.getX(0)+2]==1 || MapaTiles.map[personaje.getY(0)+3][personaje.getX(0)+2]==1)){
    					auxX=personaje.getX(0);
    					if(bloqueado()==true || accionActual==4 || accionActual==2){ 
    	        			personaje.animar(0,accionAnterior);
    	        			accionActual=accionAnterior;
    			...
    			if((izquierda==true || izquierda2==true) && derecha==false && derecha2==false && accionActual!=5){//si no puede mover el pie hacia la izquierda.
    				if((MapaTiles.jugadores[personaje.getY(0)+3][personaje.getX(0)]==1 || MapaTiles.jugadores[personaje.getY(0)+3][personaje.getX(0)]==1) || (MapaTiles.map[personaje.getY(0)+3][personaje.getX(0)]==1 || MapaTiles.map[personaje.getY(0)+3][personaje.getX(0)]==1)){
    					auxX=personaje.getX(0);
    					if(bloqueado()==true || accionActual==4 || accionActual==2){ 
    	        			personaje.animar(0,accionAnterior);
    	        			accionActual=accionAnterior;

...
public class Jugador4 implements KeyListener {
	
	//metodos por jugador:
	//animar,getX,getY,setX,setY.
	
	public static int teclaIzquierda=Teclas.teclas[3][0];
	public static int teclaDerecha=Teclas.teclas[3][1];
	public static int teclaDisparo=Teclas.teclas[3][5];
	public static int teclaSalto=Teclas.teclas[3][4];
	public static int teclaAgacharse=Teclas.teclas[3][2];
	public static int teclaArriba=Teclas.teclas[3][3];
        public static int teclaCorriendo=Teclas.teclas[3][6];
        public static int teclaCambiar=Teclas.teclas[3][7];
    ...
    private int marcaPasos=0,contadorSprite=0,contador=0,accionActual=0,auxX=personaje.posIniX[1],auxY=personaje.posIniY[1];
    //nuevo actualizar:
    ...
    public boolean[] contadorDeRetardo=new boolean[5];//0=quieto, 5 velocidades (3,1,2,4,8).
    
    public Jugador4(){
            teclaIzquierda=Teclas.teclas[3][0];
            teclaDerecha=Teclas.teclas[3][1];
            teclaDisparo=Teclas.teclas[3][5];
            teclaSalto=Teclas.teclas[3][4];
            teclaAgacharse=Teclas.teclas[3][2];
            teclaArriba=Teclas.teclas[3][3];
            teclaCorriendo=Teclas.teclas[3][6];
            teclaCambiar=Teclas.teclas[3][7];
        }
    ...
    public void actualiza2(){
        ...
        if((contadorDeRetardo[3]==true && ralentizacion==false) || contadorDeRetardo[1]==true || contadorDeRetardo[4]==true || (contadorDeRetardo[2]==true && (corriendoAire==true || (saltar==false && cayendo==false)))){
            ...
            posAnterior=Personaje.accion[3];
            pos=0;
            ...
            if(!((izquierda || izquierda2) && (derecha || derecha2)) && (izquierda || izquierda2 || derecha || derecha2)){//si solo esta activada 1 direccion de las 2 y por lo menos 1:
                if(derecha || derecha2){
                    if(paso==true){
                        if(paso2==false){
                            Personaje.contadorSprite[3]=7;
                            paso2=true;
                        }else{
                            Personaje.contadorSprite[3]=9;
                            paso2=false;
                        }
                        paso=false;
                        pos=1;
                        ...
                        if(paso3==false){
                            Personaje.contadorSprite[3]=8;
                            paso3=true;
                        }else{
                            Personaje.contadorSprite[3]=10;
                            paso3=false;
                        }
                        paso=true;
                        pos=0;
                ...
                if(izquierda || izquierda2){
                    if(paso==true){
                        if(paso2==false){
                            Personaje.contadorSprite[3]=1;
                            paso2=true;
                        }else{
                            Personaje.contadorSprite[3]=3;
                            paso2=false;
                        }
                        paso=false;
                        pos=3;
                        ...
                        if(paso3==false){
                            Personaje.contadorSprite[3]=2;
                            paso3=true;
                        }else{
                            Personaje.contadorSprite[3]=4;
                            paso3=false;
                        }
                        paso=true;
                        pos=0;
                ...
                paso3=false;
                if(direccion==1){//izq
                    Personaje.contadorSprite[3]=5;
                }else{
                    Personaje.contadorSprite[3]=11;
                }
            }
            ...
            if(agacharse || agacharse2){
                pos=6;
                if(mx==1){
                    Personaje.contadorSprite[3]=13;
                }else{
                    if(mx==-1){
                        Personaje.contadorSprite[3]=12;
                    }else{
                        if(direccion==2){
                            Personaje.contadorSprite[3]=13;
                        }else{
            ...
            if(arriba || arriba2){
                pos=5;
                if(mx==1){
                    Personaje.contadorSprite[3]=6;
                }else{
                    if(mx==-1){
                        Personaje.contadorSprite[3]=0;
                    }else{
                        if(direccion==2){
                            Personaje.contadorSprite[3]=6;
                        }else{
        ...
        if(contadorDeRetardo[3]==true){
            if((espacio || espacio2) && (((cayendo==false  && saltar==true) && altura<Actualizaciones.saltoJugador[3]) || volar==true)){
                my--;
                if(volar==false){
                    altura++;
                }else{
                ...
                if(desbloqueado(posAnterior,Personaje.x[3],Personaje.y[3]+1)){
                    cayendo=true;
                }else{
                    saltar=true;
                    altura=0;
                ...
                if((espacio || espacio2) && cayendo==false && saltar==true && altura<Actualizaciones.saltoJugador[3]){
                    my--;
                    if(volar==false){
                        altura++;
                    }else{
        ...
        if(!(MapaTiles.mapaFisico[personaje.getY(3)+3][personaje.getX(3)+1+mx]==1 || MapaTiles.jugadores[personaje.getY(3)+3][personaje.getX(3)+1+mx]==1 || MapaTiles.mapaFisico[personaje.getY(3)+3][personaje.getX(3)+1]==1 || MapaTiles.jugadores[personaje.getY(3)+3][personaje.getX(3)+1]==1) && (desbloqueado(pos,Personaje.x[3]+mx,Personaje.y[3]+my) || desbloqueado(posAnterior,Personaje.x[3]+mx,Personaje.y[3]+my))){//si ademas esta empalado.
            Personaje.x[3]+=mx;
            Personaje.y[3]+=my;
        }else{
            if(!(MapaTiles.mapaFisico[personaje.getY(3)+3][personaje.getX(3)+1+mx]==1 || MapaTiles.jugadores[personaje.getY(3)+3][personaje.getX(3)+1+mx]==1 || MapaTiles.mapaFisico[personaje.getY(3)+3][personaje.getX(3)+1]==1 || MapaTiles.jugadores[personaje.getY(3)+3][personaje.getX(3)+1]==1) && (desbloqueado(pos,Personaje.x[3]+mx,Personaje.y[3]))){//si ademas esta empalado.
                Personaje.x[3]+=mx;
            }else{
                if(desbloqueado(posAnterior,Personaje.x[3]+mx,Personaje.y[3])){
                    pos=posAnterior;
                    switch(pos){
                        case 0:
                            if(direccion==1){
            ...
            if(desbloqueado(pos,Personaje.x[3],Personaje.y[3]+my)){
                Personaje.y[3]+=my;
            }else{
                if(desbloqueado(posAnterior,Personaje.x[3],Personaje.y[3]+my)){
                    pos=posAnterior;
                    switch(pos){
                        case 0:
                            if(direccion==1){
        ...
        if(contadorDeRetardo[1]==true || contadorDeRetardo[2]==true || contadorDeRetardo[3]==true || contadorDeRetardo[4]==true){
            ...
            if(!desbloqueado(pos,Personaje.x[3],Personaje.y[3])){
                pos=posAnterior;
                    switch(pos){
                        case 0:
                            if(direccion==1){
            ...
            if(curandose2()){
                if(personaje.vidas[3]<act.vidaJugador[3]){
                    personaje.vidas[3]++;
                }
            }
            ...
            switch(tomoUnItem()){
                case 0://nada.
                    break;
                case 26://pelotas.
                    act.municionPelotas[3]=act.municionPelotas[3]+act.tamañoCartuchoPelotas;
                    act.armaActual[3]=2;
                    break;
                case 33://misiles.
                    act.municionMisiles[3]=act.municionMisiles[3]+act.tamañoCartuchoMisiles;
                    break;
                case 37://capsula curativa.
                    Personaje.vidas[3]+=act.curacionCapsulas;
                    if(Personaje.vidas[3]>act.vidaJugador[3]) Personaje.vidas[3]=act.vidaJugador[3];
                    break;
            ...
            if(indiceCheck!=-1){
                act.checkJugador[3]=indiceCheck;
            }
        ...
        if((cambiar || cambiar2) && cambiado==false){
            ...
            while(cambio==false){
                if(act.armaActual[3]<(act.limiteArmas-1)){
                    act.armaActual[3]++;
                }else{
                    act.armaActual[3]=1;
                }
                switch(act.armaActual[3]){
                    case 1:
                        cambio=true;
                        break;
                    case 2:
                        if(act.municionPelotas[3]>0){
                            cambio=true;
                        }
                        break;
                    case 3:
                        if(act.municionMisiles[3]>0){
                            cambio=true;
                        }
                        break;
                }
        ...
        switch(act.armaActual[3]){
            ...
            case 1://pistola(la ametralladora aparece cuando tiene mejora de 2x velocidad ataque)
                retardoArmaActual=act.retardoBalas/act.velocidadAtaque[3];
                break;
            case 2://arma boteadora.
                retardoArmaActual=act.retardoPelotas/act.velocidadAtaque[3];
                break;
            case 3://lanza misiles
                retardoArmaActual=act.retardoMisiles/act.velocidadAtaque[3];
                break;
        ...
        if((disparo || disparo2) && pos!=5 && contadorDisparo==0){// && disparado==false(para q dispare estilo megaman)
            ...
            switch(act.armaActual[3]){
                ...
                break;
            case 1://pistola(la ametralladora aparece cuando tiene mejora de 2x velocidad ataque)
                balas.nuevaBala(3,direccion,Personaje.x[3],Personaje.y[3]);
                contadorDisparo++;//(1)
                break;
            case 2://arma boteadora.
                balas.nuevaPelota(3,direccion,Personaje.x[3],Personaje.y[3]);
                contadorDisparo++;//(1)
                break;
            case 3://lanza misiles
                //balas.nuevoMisil(3,direccion,Personaje.x[3],Personaje.y[3]);
                contadorDisparo++;//(1)
                break;
            }
    	}
        ...
        personaje.direccion[3]=this.direccion;
    }

    //nuevo metodo:
    public void reaparecer(){
        this.reap=false;
        if(act.checkJugador[3]==-1){
            personaje.setX(3,personaje.posIniX[3]);
            personaje.setY(3,personaje.posIniY[3]);
        }else{
            personaje.setX(3,MapaTiles.punto.get(act.checkJugador[3]).posicionPuntoX-1);
            personaje.setY(3,MapaTiles.punto.get(act.checkJugador[3]).posicionPuntoY-3);
        }
    	auxX=personaje.getX(3);
    	auxY=personaje.getY(3);
    }
    ...
    public int tomoUnItem(){
        for(int k=0;k<MapaTiles.items.size();k++){
            for(int i=0;i<4;i++){
                for(int j=0;j<3;j++){
                    if(personaje.personaje[3][i][j]==1){
    			if((Personaje.y[3]+i)==MapaTiles.items.get(k).posicionItemY && (Personaje.x[3]+j)==MapaTiles.items.get(k).posicionItemX){
    ...
    public int tomoUnCheckPoint(){
        for(int k=0;k<MapaTiles.punto.size();k++){
            for(int i=0;i<4;i++){
                for(int j=0;j<3;j++){
                    if(personaje.personaje[3][i][j]==1){
    			if((Personaje.y[3]+i)==MapaTiles.punto.get(k).posicionPuntoY && (Personaje.x[3]+j)==MapaTiles.punto.get(k).posicionPuntoX){
    ...
    public int sePuedeAgarrar(){//0=no,1=izq,2=der.
        if((izquierda || izquierda2) && MapaTiles.mapaFisico[Personaje.y[3]+1][Personaje.x[3]]==0 && MapaTiles.jugadores[Personaje.y[3]+1][Personaje.x[3]]==0 && (MapaTiles.mapaFisico[Personaje.y[3]+2][Personaje.x[3]]==1 || MapaTiles.jugadores[Personaje.y[3]+2][Personaje.x[3]]==1)){
            return 1;
        }
        if((derecha || derecha2) && MapaTiles.mapaFisico[Personaje.y[3]+1][Personaje.x[3]+2]==0 && MapaTiles.jugadores[Personaje.y[3]+1][Personaje.x[3]+2]==0 && (MapaTiles.mapaFisico[Personaje.y[3]+2][Personaje.x[3]+2]==1 || MapaTiles.jugadores[Personaje.y[3]+2][Personaje.x[3]+2]==1)){
            return 2;
        }
        return 0;
    }
    ...
    public boolean quemandose2(){
        if(personaje.estaVivo[3]==true){
    	if(Personaje.y[3]+3<Juego.alto && Personaje.y[3]>=0 && Personaje.x[3]+2<Juego.ancho && Personaje.x[3]>=0){
    		for(int i=0;i<4;i++)
    			for(int j=0;j<3;j++)
    				if(personaje.personaje[3][i][j]==1)
    					if(MapaTiles.mapaFisico[Personaje.y[3]+i][Personaje.x[3]+j]==2){
    						return true;
    					}
    	}
        }
    ...
    public boolean curandose2(){
    	...
    	if(Personaje.y[3]+3<Juego.alto && Personaje.y[3]>=0 && Personaje.x[3]+2<Juego.ancho && Personaje.x[3]>=0){
    		for(int i=0;i<4;i++)
    			for(int j=0;j<3;j++)
    				if(personaje.personaje[3][i][j]==1)
    					if(MapaTiles.mapaFisico[Personaje.y[3]+i][Personaje.x[3]+j]==3){
    						return true;
    					}
    	}
        }
    ...
    public boolean aguandose(){
    	...
    	if(Personaje.y[3]+3<Juego.alto && Personaje.y[3]>=0 && Personaje.x[3]+2<Juego.ancho && Personaje.x[3]>=0){
    		for(int i=0;i<4;i++)
    			for(int j=0;j<3;j++)
    				if(personaje.personaje[3][i][j]==1)
    					if(MapaTiles.mapaFisico[Personaje.y[3]+i][Personaje.x[3]+j]==4){//si es agua.
    						return true;
    					}
    	}
        }
    ...
    public boolean perdio(){
        if(Teclas.modoJuego==1){
            if(personaje.puntos[3]<=0){
                personaje.estaVivo[3]=false;
                return true;
            }
        }else{
            if(personaje.puntos[3]<=0){
        ...
        if(Teclas.modoJuego==1){
            ...
            for(int i=0;i<3;i++){
                for(int j=0;j<4;j++){
                    ...
                    if(((personaje.getX(3)+i)==Teclas.estrellaX && (personaje.getY(3)+j)==Teclas.estrellaY && personaje.estaVivo[3]==true) || jr<=0){
                        Jugador1.reap=true;
                        Jugador2.reap=true;
                        Jugador3.reap=true;
                        Jugador4.reap=true;
